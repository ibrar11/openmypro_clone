...
export default function NewToBlossendSection() {
      ...
      <div className="carousel-header">
        ...
        <div className="carousel-header">
          <h3 className="carousel-title"> 
            <span className="carousel-title-subtext">New to Blossend</span>
        ...
        <p className="available-subtitle">
          Meet the latest professionals who recently joined OpenMyPro by Blossend!
        </p>
      </div>
      <DoctorCardSlider
        doctors={doctors}
