import DoctorCardSlider from "./AvailableSectionComponents/DoctorCardSlider";
      ...
      <div className="carousel-header">
        ...
        <div className="carousel-header">
          <h3 className="carousel-title"> 
            <span className="carousel-title-subtext">Available Now</span>
        ...
        <div className="carousel-header-divider"></div>
