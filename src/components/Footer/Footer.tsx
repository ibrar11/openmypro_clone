...
export default function Footer() {
  return (
    <footer className="footer-section">
      <div className="container">
        ...
        <div className="logo-section">
          <Link href="https://www.blossend.com">
            <img
              alt="logo"
              loading="lazy"
              width="200"
          ...
          <ul className="socials">
            <li>
              <Link href="https://www.linkedin.com/company/blossend/">
                <svg 
            ...
            <li>
              <Link href="https://www.instagram.com/blossend.apps/">
                <svg 
                  style={{width:'40px', height: '40px', color: '#4a5565'}}
                  focusable="false" 
                  aria-hidden="true" 
        ...
        <div className="links">
          ...
          <ul className="downloads">
            <li>
              <Link href="https://apps.apple.com/us/app/open-my-doctor-doctor-finder/id6737090324">
                <img
                  alt="appleStore"
                  loading="lazy"
                  width="200"
            ...
            <li>
              <Link href="https://play.google.com/store/apps/details?id=com.blossend.omd">
                <img
                  alt="googlePlay"
                  loading="lazy"
                  width="200"
        ...
        <div className="links">
          ...
          <ul className="link-list">
            <li>
              <Link className="link" href="https://www.blossend.com/contact">
                Help & Support
              </Link>
            </li>
            <li>
      ...
      <div className="copyright">
        <p>
          ...
          <span className="inline-link">
            <Link href="https://www.blossend.com">Blossend.</Link>
          </span>{" "}
          All rights reserved.
        </p>
      </div>
      ...
      <div className="footer-section-links">
        <ul>
          <li>
            <Link className="link" href="/Terms&Conditions">
              Terms of Service
            </Link>
          </li>
    ...
    //         <Link href="#"><img src="/icons/whatsapp.svg" alt="WhatsApp" /></Link>
    //         <Link href="#"><img src="/icons/linkedin.svg" alt="LinkedIn" /></Link>
    ...
    //       <h4>Download</h4>
    //       <Link href="#"><img src="/appstore.png" alt="App Store" className="store-badge" /></Link>
    //       <Link href="#"><img src="/googleplay.png" alt="Google Play" className="store-badge" /></Link>
    //     </div>
    ...
    //     <p>Copyright © 2024 <Link href="#">Blossend</Link>. All rights reserved.</p>
