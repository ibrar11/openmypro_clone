...
export default function AlternativeProsSection() {
const doctors = [
  {
    id: 1,
      ...
      <div className="carousel-header">
        ...
        <div className="carousel-header">
          <h3 className="carousel-title"> 
            <span className="carousel-title-subtext">Alternative Blossend Pros</span>
          ...
          <button className="carousel-header-button">
            See all
          </button>
        </div>
        <div className="carousel-headerdivider"></div>
        <p className="available-subtitle">
          Can’t find who you are looking for? Try these other Blossend options
        </p>
      </div>
      <DoctorCardSlider
        doctors={doctors}
